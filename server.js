...
app.post('/api/generate-timetable', async (req, res) => {
    ...
    try {
        ...
        // Initialiser les volumes horaires restants
        ...
        // Vérifier les matières des enseignants
        ...
        for (const group of groups) {
            ...
            for (const day of days) {
                for (const slot of timeSlots) {
                    ...
                    // Trouver les enseignants et salles disponibles
                    ...
                    if (availableTeachers.length && availableRooms.length) {
                        // Créer une liste de combinaisons enseignant/matière valides
                        ...
                        if (validAssignments.length) {
                            // Choisir une combinaison aléatoire
                            ...
                            // Mettre à jour l'emploi du temps de l'enseignant
            ...
            // Appliquer les contraintes d'indisponibilité
